...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"login","method":"post","propertyName":"token"},"logout":false,"user":{"url":"me","method":"get","propertyName":"user"}},"_name":"local"}))
